...
public class FilePath {
    ...
    public static final  String accessKeyId = "LTAIWOJiEXDiiY9K";
    public static final  String accessKeySecret = "0GQxrDVLr1ohyCMGFZL8Ej9OuZpUvg";
